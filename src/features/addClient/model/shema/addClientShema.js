...
export const addClientShema = yup.object({
  ...
  procedure: yup
    .string()
    .required("Будь ласка, введіть процедуру")
    .min(2, "Назва процедури занадто коротка")
    .max(100, "Назва процедури занадто довга"),
  ...
  price: yup
    ...
    .when("$isPrivileged", {
      is: true,
      then: (schema) => schema.required("Будь ласка, введіть ціну"),
    })
