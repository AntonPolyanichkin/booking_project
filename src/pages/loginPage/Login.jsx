        ...
        <div className={style.login__content}>
          <div className={`${style.login__about} ${style["about-info"]}`}>
            ...
            <div className={style["about-info__text-container"]}>
              <h2 className={style["about-info__main-text"]}>Управління записами клієнтів</h2>
              <p className={style["about-info__text"]}>Професійна система для бізнесу. Календар, записи, аналітика — все в одному місці. </p>
            </div>
            <div className={`${style.login__about} ${style["about-benefits"]}`}>
